...
import imglogo from '../../images/M.png'
...
const dispatch = useDispatch()
  return (
    <div className={`h-[80px] ring-indigo-600  shadow-lg flex items-center fixed top-0 left-0 w-[100%] z-50 justify-between ${darkMode ? 'border-slate-50 bg-dark border-b-2' : 'bg-white'}`}>
      <div className='h-full w-[300px] flex justify-between  items-center '>
      <img className={`h-[35%] w-[35%] md:h-[60%] md:w-[60%] bg-transparent object-cover ${darkMode ? 'text-white' : '' }`} src={imglogo} alt="Description de l'image SVG"/>
      </div>
